...
import { Smartphone, Server, ArrowRight, Lock, Unlock, Key, Send } from 'lucide-react';
...
const WebCryptoDemo = () => {
  ...
  const encryptMessage = async () => {
    try {
      ...
      const dataToEncrypt = new Uint8Array(randomPadding.length + messageData.length);
        ...
        <CardContent>
          ...
          <div className="flex items-start justify-between gap-4 mb-8">
            ...
            <div className="flex flex-col items-center justify-center pt-12">
              <ArrowRight className={`w-8 h-8 transition-all duration-500 ${isSending ? 'text-green-500 scale-125' : 'text-gray-400'}`} />
            </div>
